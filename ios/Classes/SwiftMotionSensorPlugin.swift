...
public class SwiftMotionSensorPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let METHOD_CHANNEL_NAME = "motion_sensor/method"
        let instance = SwiftMotionSensorPlugin(registrar: registrar)
    ...
    init(registrar: FlutterPluginRegistrar) {
        let ACCELEROMETER_CHANNEL_NAME = "motion_sensor/accelerometer"
        let MAGNETOMETER_CHANNEL_NAME = "motion_sensor/magnetometer"
        let GYROSCOPE_CHANNEL_NAME = "motion_sensor/gyroscope"
        let USER_ACCELEROMETER_CHANNEL_NAME = "motion_sensor/user_accelerometer"
        let ORIENTATION_CHANNEL_NAME = "motion_sensor/orientation"
        let ABSOLUTE_ORIENTATION_CHANNEL_NAME = "motion_sensor/absolute_orientation"
        let SCREEN_ORIENTATION_CHANNEL_NAME = "motion_sensor/screen_orientation"
