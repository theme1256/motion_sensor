...
const MethodChannel _methodChannel = MethodChannel('motion_sensor/method');
const EventChannel _accelerometerEventChannel = EventChannel('motion_sensor/accelerometer');
const EventChannel _gyroscopeEventChannel = EventChannel('motion_sensor/gyroscope');
const EventChannel _magnetometerEventChannel = EventChannel('motion_sensor/magnetometer');
const EventChannel _userAccelerometerEventChannel = EventChannel('motion_sensor/user_accelerometer');
const EventChannel _orientationChannel = EventChannel('motion_sensor/orientation');
const EventChannel _absoluteOrientationChannel = EventChannel('motion_sensor/absolute_orientation');
const EventChannel _screenOrientationChannel = EventChannel('motion_sensor/screen_orientation');

// from https://github.com/flutter/plugins/tree/master/packages/sensor
